...
declare type CanvasAttributes = React.CanvasHTMLAttributes<HTMLCanvasElement>;
export interface SplineProps extends Omit<CanvasAttributes, 'onLoad' | 'onMouseDown' | 'onMouseUp' | 'onMouseHover' | 'onKeyDown' | 'onKeyUp' | 'onWheel'> {
    scene: string;
